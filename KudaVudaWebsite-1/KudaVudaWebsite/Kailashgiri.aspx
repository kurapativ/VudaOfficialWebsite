<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Kailashgiri.aspx.vb" Inherits="Kailashgiri" MasterPageFile="~/vudamaster.master"  %>
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form>
        <div id="wrapper">
            <div class="w1">
                <div class="itemtitle">
                    <h4 class="auto-style9">KAILASAGIRI </h4>
                </div>
                <div id="content_t">
                    <h4 class="auto-style9">Kailasagiri- A never ending enchantment: </h4>
                    <P>
                        <img src="http://www.vuda.gov.in/images/kailasagiri1.jpg" width="230" height="191" style="float:right;"/></P>
                    <p style="float:left; width:650px;" class="auto-style9">
                        It is one of the prominent hill top parks with panoramic sea view on the East Coast. The divine view from the hilltop accompanies devotional overtones as the Lord Shiva and Goddess Parvathi sits ever so peacefully as if at the Manasa Sarovar in the great Himalayas. One can view the entire city of Visakhapatnam from the top of this Eco-Rich hill. <br>
                        <br>Located on a picturesque hill with enchanting panoramic sea view, Kailasagiri is
        really an outstanding tourist spots in Andhra Pradesh. It is the Queen among the
        tourist locations in the City of Destiny. The hill park developed by VUDA covers
        380 acres of land with exciting landscape gardens consisting rich flora and tropical
        trees. Situated at an altitude of 360 ft., the hill park gives fascinating views
        of sun kissed beaches on one side and the lush green forests on the other side beside
        an enthralling view of the bustling metropolis of Visakhapatnam. 
                        <br />
                        ...
                        <br />The Government of Andhra Pradesh has awarded Kailasagiri as &quot;the Best   Tourist Spot&quot; in 2003. The hilltop is well connected by all means of   transport through ghat road Facing the City and seawaters. Two stairways   are provided for pedestrians Pleasant weather prevails throughout the   year on the hilltop.<br />
                        <br />An exclusive Butterfly Park, Highest Manmade Water Falls are proposed   projects on the hilltop. On an average around 3 lakh Indian and Foreign   tourists visit this spot every year. It became a must-see place for all   the visitors coming to Visakhapatnam including State guests and other   VIPs. Above all Kailasagiri is the first location where plastic use is   banned and implemented strictly to protect and promote healthy   eco-balance.<br />
                        <br />VUDA has declared the hill a plastic-free zone. Tourists are not   insisted and imposed rules to follow orders on plastic ban but educated   and convinced to practice it voluntarily and succeeded to that effect. 
                        <br>
                        <br><b>Entry Fee:</b>
                        <br>Film shootings : Rs.7500/- 
                        <br>TV serials : Rs.3000/- 
                        <br>Film shooting/TV Serial : Rs.5000/- 
                        <br>Lawn cleaning charges : Rs.1000/- 
                        <br>Entry fee for Pedestrians : Rs.5/- 
                        <br>Park entry fee for RTC passengers : Rs.5/- per day 
                        <br>2 wheelers : Rs.20/- per day 
                        <br>4 wheelers : Rs.50/- per day
                        <br>
                        4 wheelers big : Rs.70/- per day 
                        <br>Mini bus : Rs.150/- 
                        <br>Tourist bus : 300/- 
                        </P>
                    <p style="float:left; width:650px;">
                        <br>
                        <br />
                    </p>
                    <div class="clr">
