<%@ Page Language="VB" AutoEventWireup="false" CodeFile="tender.aspx.vb" Inherits="tender" MasterPageFile="~/vudamaster.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >

    <table border="1" cellspacing="0" cellpadding="0">
        <tr>
            <td colspan="2" align="center">ARCHIVE OF TENDERS</td>
        </tr>
        <tr>
