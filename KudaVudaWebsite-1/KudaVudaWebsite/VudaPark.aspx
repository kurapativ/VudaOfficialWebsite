<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VudaPark.aspx.vb" Inherits="VudaParks" MasterPageFile="~/vudamaster.master"   %>
...
<div id="wrapper">
  <div class="w1">
      ...
      <div id="content_t">
          <h4>VUDA Park </h4>
          <P>
              <img src="http://www.vuda.gov.in/images/pic09.jpg" width="230" height="191" style="float:right;"/></P>
          <p class="auto-style9">
          ...
          <h4 style="text-align: left">VUDA Children World-unique for Children</h4>
          <p class="auto-style9">
              VUDA Children World has been promoted by VUDA, as exclusive premises for the Children of Vizag with many facilities. 
              <br />The Children World consists of 
              <br />1. The Children Theatre, 
              <br />2. The Children Club, 
              <br />3. Mini library and<br />4. Mini Zoo, existing at a prime area in Siripuram Junction. Those   children, who become members of the VUDA Children Club, are eligible to   enjoy all the above facilities<br />
              <br />
          </P>
              ...
              <div>
                  <div>
                      <div>
                          <div>
                              <p class="auto-style9">
                                  <strong>Entry Fee:</strong><br />Film shootings: Rs.5, 000/-<br />TV/serials: Rs.2, 000/-<br />Film shooting/TV Serial: Rs.5, 000/-<br />Lawn cleaning charges: Rs.500/-<br />Entry fee: Rs.5/-<br />
                              </p>
                          </div>
                      </div>
                  </div>
