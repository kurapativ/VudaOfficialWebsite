<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KidsPride.aspx.vb" Inherits="KidsPride" MasterPageFile="~/vudamaster.master"   %>
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form>
<div id="wrapper">
    <div class="content">
    <div class="itemtitle">
      <h4 class="auto-style9">VUDA KIDS PRIDE</h4>
    </div>
    <div id="content_t">
      <h4 class="auto-style9">&quot;VUDA Kids Pride&quot;</h4>
      <P><img src="http://www.vuda.gov.in/images/kidapic1.jpg" width="230" height="191" style="float:right;"/></P>
      <p class="auto-style9">The Adventurous Park Exclusively for children on seashore <br />
        ...
        <br />
        The abandoned lighthouse premises adjacent to the VUDA Park, has been developed      by VUDA into a marvelous place for kids.<br />
        <br />
      </p>
      <p class="auto-style9"> VUDA proudly presented the &quot;Kids Pride&quot; Adventure Park and dedicated to the children      on 15-05-2004.<br />
      </p>
      <div class="clr"></div>
      <P class="auto-style9">VUDA, which is pioneering in shaping Vizag, launched this innovative project enabling      the little stars to shine with creativity and capabilities by using the facilities      promoted here. This kind of exclusive facilities for children can be seen in the      Western Countries and VUDA is the first to promote such theme park for the children      at Visakhapatnam, the City of Destiny.<br />
        <br />
      </P>
      <h4 class="auto-style9">Objectives: <br />
      </h4>
      <p class="auto-style9"> The main objectives in developing the Kids Pride Adventure Park are<br />
      </P>
      <p class="auto-style9"><img src="http://www.vuda.gov.in/images/arrow1.jpg" width="10" height="10" /> To provide a healthy and jolly atmosphere for the kids to spend their summer as well as regular holidays fruitfully,<br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" width="10" height="10" /> To inculcate the qualities of inquiry, importance of physical fitness and self determination among children, <br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" width="10" height="10" /> To enjoy safe beach view and <br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" width="10" height="10" /> To earmark an exclusive location for children of all ages on seashore.<br />
        VUDA took keen interest for dedicating this park to children with a   variety of facilities to generate the qualities of creativity, integrity   by inculcating physical and psychological standards and fitness among   children of all ages. The uniqueness of this activity is that the   children of all ages were made to actively participate to design the   surroundings and amenities at the premises. Children from various   Municipal and Charity Schools were invited and involved to offer   suggestions and ideas on how and what kind of facilities should be   provided here. The developments in the park have been taken place   according to the wishes of the children. Murals were painted by children   of all ages.. <br />
        <br />
      </P>
      ...
      <p class="auto-style9"> <img src="http://www.vuda.gov.in/images/arrow1.jpg" width="10" height="10" /> Telescope on the top of the Light House as a highlight to the Park<br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> Mini children Library<br />
        ...
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> Adventure trail: Wooden Bridge with net and small gaps for Adventure Trial facing the sea<br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> Rock climbing</p>
      <p class="auto-style9"><img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> Wall climbing</p>
      <p class="auto-style9"> <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> Indoor games such as Chess and caroms etc. </p>
      <p class="auto-style9">Most of these facilities were developed in consultation with the   children. Two interactive sessions were held with more than 200 school   children at the site and sought their opinions and suggestions on how to   develop facilities in the Park. The concept of involving the users   yielded fruitful outputs and the lighthouse kid's park earned many   innovative facilities. </p>
      ...
      <p class="auto-style9"><img src="http://www.vuda.gov.in/images/arrow1.jpg" width="10" height="10" />   Entry is free to all those who are members in Children (theatre) Club<br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />    For Non-Members, till the time they enroll as members they have to pay   an entry fee of Rs.5/- (Rupees five only) per child. The amount   collected will be utilized &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for creating more facilities for children at   the park<br />
        <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />  The Park opens for kids every day from 11.00 AM to 7.00 PM </p>
      <div class="clr"></div>
    </div>
    <div class="clr"></div>
  </div>
