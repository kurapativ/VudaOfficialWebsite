<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bheemilibeach.aspx.vb" Inherits="bheemilibeach" MasterPageFile="~/vudamaster.master"  %>
...
<div id="wrapper">
  <div class="content">
    ...
    <div id="content_t">
      <h4>Beach Park on Visakha-Bheemili Beach Road: </h4>
      <P><img src="http://www.vuda.gov.in/images/v_parkpic01.jpg" width="230" height="191" style="float:right;"/></P>
      <p style="float:left; width:650px; text-align: left;">Realizing the need to develop infrastructure for promotion of tourism at   global level, VUDA has taken up the widening of existing road between   Visakha and Bheemili into a four-lane corridor. This project not only   provides state of art transport facilities between the two major tourist   port locations, but also earns global recognition to tourism at   Visakhapatnam. <br />
        <br />
        The 26 km road goes all along the beach from Visakhapatnam to Bheemili. The work      is in progress. The first 2km stretch has been completed with all beautifications. <br />
        <br />
