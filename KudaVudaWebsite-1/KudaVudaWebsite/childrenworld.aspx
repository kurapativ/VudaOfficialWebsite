<%@ Page Language="VB" AutoEventWireup="false" CodeFile="childrenworld.aspx.vb" Inherits="childrenworld" MasterPageFile="~/vudamaster.master"   %>
...
<div id="wrapper">
  <div class="w1">
      <div class="itemtitle">
          <h4>VUDA CHILDREN WORLD</h4>
      </div>
      <div id="content_t">
          <div  style=" width:528; height:30px; background-color:#a5c640;">
              <div style="text-align:center; font-size:16px; font-weight:bold; color:White;">
                  Have great time making friends!</div>
          </div>
          <div style="width:200px; float:left;">
              <img src="http://www.vuda.gov.in/images/dogs.jpg" width="200" height="131" /></div>
          <div style="font-family:Arial, Helvetica, sans-serif; font-size:12px; width:750px; float:right; margin-top: 20px;">
              <p>
                  It's not how many ideas you have. Its how many you make happen. All you need to do is choose.... from making new friends to sharing lasting memories with them. That's what the newly formed VUDA Children's Club is trying to do. It's the one place you'll find no assignments, no rules, no restrictions but tons and tons of fun. A right place to be your self. After all, all work and no play makes.....!!!</p>
          </div>
      ...
      <div id="Div1">
          <h4>
              <img src="http://www.vuda.gov.in/images/share.jpg" width="950" height="98" /></h4>
      </div>
      <div id="Div2">
          <p class="auto-style9">
              ...
              <br />
              <br />Visakhapatnam Urban development Authority (VUDA) takes a big step forward to understanding children better. The new Children's Club at the VUDA Children's World, would soon be the talk of the town in the direction of childcare. The right place where children can grow, not just in size, not even in knowledge but in curiosity, courage, confidence, independence, patience, competence, understanding and resourcefulness. Vizag kids, definitely deserve a place of their own to unleash their talents to fulfill their limitless ambitions.<br />
              <br />Come, be part of VUDA’s earnest endeavor to give children access to enough of the world. And to help them to take a better path into that world than anyone could ever make for them.</p>
      </div>
      <div id="Div3">
          <h4 class="auto-style9"><span class="headepurpose33p">On what we do </span></h4>
          <p class="auto-style9">
              <span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Screening of educational and entertainment films.<br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Organizing cultural programs.<br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Conducting workshops &amp; training classes on painting and handicrafts.<br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Lectures, seminars and counseling sessions on important topics &amp; issues.<br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Literary competitions.<br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Organizing functions and competitions on days of special interest.<br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Special programs for challenged children. 
              <br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Promotion of adventure sports and indoor games. 
              <br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span> Science and technology exhibitions/fairs 
              <br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span>And many more. 
              <br />
          </p>
          <p class="auto-style9">
      ...
      <div id="Div4">
          <h4 class="auto-style9">Individual Members </h4>
          <p class="auto-style9">
              <span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> Individuals are required to become members of the Children's Club by paying a nominal membership fee. </span>
              <br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /> They can opt for annual / life membership. 
              <br />
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />Only after becoming a Club member are the children entitled to participate in the activities mentioned.</span>
              <br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />Fill up the enrolment form, pay the necessary fee & collect your membership card for annual / life membership. </span>
          </p>
      </div>
      <div id="Div5">
          <h4 class="auto-style9">Donor Members </h4>
          <p class="auto-style9">
              <span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />Institutions / service Organizing / individuals can become donor members by generously donating for the cause of children.</span><br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />The funds will be utilized for financially weak children belonging to the Govt. / Municipal schools.</span><br /><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" />Donors will be awarded a “Certificate of Appreciation” and memento towards the service rendered to the poor children. VUDA will honor such donors and their list will be displayed at the Children's Theatre.</span><br />
          </p>
      </div>
      <div id="Div6">
          <h4 class="auto-style9">For educational Institutions </h4>
          <p class="auto-style9">
              <span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span>Own our theatre for a day is designed to give the educational institutions an opportunity to celebrate their annual day function / or any appropriate event exclusively at the Children's World for the whole day.<br/><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span>They can utilize the entire infrastructure &amp; facilities available at the venue such as the mini-zoo, library, play items, indoor air-conditioned theatre for children's film shows and other school activities.<br/><span>
              <img src="http://www.vuda.gov.in/images/arrow1.jpg" alt="" width="10" height="10" /></span>Fill up the enrolment form, pay the necessary fee and reserve a specific calendar date to own your theatre on that day to celebrate the event.<br/>
          </p>
      </div>
      <div id="Div7">
          <h4 class="auto-style9">NGO’s committee for assistance </h4>
          <p class="auto-style9">
      ...
      <div id="Div9">
          <div class="headepurpose33ps" style="text-align:center;; margin-left:2px; background-color:#f07d46; ">
              <p style="color:White; " class="auto-style9">
                  <b>Children Club members are eligible for concessionary entry at all VUDA maintained parks and facilities.</b>
          </div>
          <div class="headepurpose33ps" style="text-align:center;; margin-left:2px; background-color:#4ccbff;">
              <p style="color:White; " class="auto-style9">
                  <b>Enroll as member today and explore the joy of being a part of the unique Children Club family.</b></p>
          </div>
      </div>
      <div class="clr">
      </div>
