<%@ Page Language="VB" AutoEventWireup="false" CodeFile="FutureProjects.aspx.vb" Inherits="FutureProject" MasterPageFile="~/vudamaster.master"   %>
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form>
<div id="wrapper">
      <div class="w1">
          <div class="itemtitle">
              <h4 style="text-align: left">FUTURE PROJECTS </h4>
          </div>
          <div id="content_t">
              <table cellspacing="0" bordercolor="#DDDDDD" border="1" rules="all" style=" width:950px">
        <!--  Table Header-->
                  <tbody>
                      <tr style="background-color:#cccccc;height:25px; font-weight:bold; color:#000;">
                          <td width="393"  style="height: 40px; text-align:center">
                              <p>
                                  Name of the Work 
                              </p>
                          </td>
                          <td width="109" style="height: 40px; text-align:center">Project Cost 
                              <br />(Rs. Cr.) </td>
                      </tr>
              <!--  Table Side Heading -->
                      <tr style="height:20px; font-size:14px">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  <span style="color:#CC0000;"><strong>MASTER PLAN ROADS</strong></span></p>
                          </td>
              ...
              <!--  Table Data-->
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:left">
                              <p>
                                  80&rsquo;-0&rdquo;  road connecting Madhurawada 100&rsquo;-0&rsquo;  road and  Law College road&#13;
                              </p>
                              <p>
                                  Length –  1.20 Km.&#13;
                              </p>
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  100&rsquo;-0&rdquo;  Kommadi road  : Length – 2.00  Km.&#13;
                              </p>
                          </td>
                          <td style="height: 20px; text-align:right">
                              <p style="text-align:right">
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  80&rsquo;-0&rdquo;  road connecting Endada and Rushikonda via Gitam College&#13;
                              </p>
                              <p>
                                  Length  - 2.50 Km&#13;
                              </p>
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  100&rsquo;-0&rdquo;  Boyapalem to Mangamaripeta  road (Formation of WMM  and SDBC &amp; SW drains for widened portion)   Length – 1.80  Km.&#13;
                              </p>
                          </td>
                          <td style="height: 20px; text-align:right">
                              <p style="text-align:right">
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  80&rsquo;-0&rdquo;  Kapulauppada to Boyapalem road  (formation of WMM and SDBC &amp; SW drains)    Length – 0.80 Km.&#13;
                              </p>
                          </td>
                          <td style="height: 20px; text-align:right">
                              <p style="text-align:right">
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  <span style="color:#CC0000;"><strong>HOUSING </strong></span>
                              </p>
                          </td>
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  <span style="color:#CC0000;"><strong>SHOPPING COMPLEXES</strong></span></p>
                          </td>
                          <td style="height: 20px; text-align:right">&nbsp;</td>
                      </tr>
                      <tr style="height:20px; font-size:14px">
                          <td style="height: 20px" class="auto-style9">
                              <p>
              ...
              <!--  Table Data-->
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  <span style="color:#CC0000;"><strong>SITES & SERVICES / PLOTTED DEVELOPMENT SCHEME </strong></span>
                              </p>
                          </td>
                          <td style="height: 20px; text-align:right">&nbsp;</td>
                      </tr>
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  Development  of layout in S.No.370/p at Madhurawada Extent -  Ac. 17.00 Cts.</p>
                          </td>
                          <td style="height: 20px; text-align:right">
                              <p style="text-align:right">
                                  3.70</p>
                      ...
                      <tr style="height:20px;">
                          <td style="height: 20px; text-align:right">
                              <p>
                                  <span style="color:#CC0000;"><strong>OTHER WORKS </strong></span>
                              </p>
                          </td>
                          <td style="height: 20px; text-align:right">&nbsp;</td>
                      </tr>
              ...
              <div id="gallery">
                  <h5 style="text-align: left">MODERN SHOPPING COMPLEX
              AT MVP COLONY </h5>
                  <ul style="text-align: left">
                      <li class="auto-style10"><a href="http://www.vuda.gov.in/images/picture/Picture27.jpg">
                      <img src="http://www.vuda.gov.in/images/picture/Picture027.jpg" width="118" height="92" /></a></li>
                      <li class="auto-style10"><a href="http://www.vuda.gov.in/images/picture/Picture29.jpg">
                      <img src="http://www.vuda.gov.in/images/picture/Picture028.jpg" width="118" height="92" /></a></li>
                      <li class="auto-style10"><a href="http://www.vuda.gov.in/images/picture/Picture29.jpg">
                          <img src="http://www.vuda.gov.in/images/picture/Picture029.jpg" width="118" height="92" /></a></li>
                      <li><a href="http://www.vuda.gov.in/images/picture/Picture30.jpg">
                          <img src="http://www.vuda.gov.in/images/picture/Picture030.jpg" width="118" height="92" /></a></li>
                  </ul>
              </div>
              <div class="clr">
                  <br />
          ...
          <div id="Div1">
              <h4 class="auto-style10">HARITHA VISAKHA</h4>
              <p class="auto-style10">
                  ...
                  <br>4 year-long project is projected at a cost of Rs 91.82 crores covering 23,370 ha., construction of 26 check dams, trenching the hill range of 21 Kms and desilting 8 tanks and rain water harvesting structure in housing schemes and other shopping complexes already developed. The project is to be submitted to JBIC or ADB for financial assistance.</p>
              <div class="clr">
              </div>
          </div>
          <div id="Div2">
              <h4 class="auto-style10">Telugu Culture &amp; Heritage Museum on Kailasagiri </h4>
              <p class="auto-style10">
                  VUDA and the World Telugu Federation have signed the Memorandum of Understanding (MoU) for establishing "Telugu Samskritika Niketanam" under the project Telugu Cultural and Heritage Museum on Kailasagiri, on Wednesday here at the conference hall, VUDA Office. The Museum intended to promote and popularize the Telugu Culture &amp; Heritage since the beginning of Satavahana era. The History of Telugu people will be depicted through pictures and other forms of display and a Light &amp; Sound show will also be organized to enlighten the visitors on Telugu History.<br>The project was mooted by the World Telugu Federation choosing Visakhapatnam as ideal place and approached VUDA to locate it on the Kailasagiri, the most popular tourist and visiting place. The proposal has been considered and VUDA agreed to establish the Telugu Cultural &amp; Heritage Museum in association with the WTF.<br>The total projects cost is Rs.5.00 cr. The WTF provides a sum of Rs.3.80 cr. VUDA contributes land on Kailasagiri and Rs.1.20 cr from its side for establishing the Museum. The Government of Andhra Pradesh has accorded permission through G.O.Rt.No.793 MA dated 27-05-2005, to establish the Telugu Cultural and Heritage Museum on Kailasagiri.<br>G.Venkatram Reddy, Vice Chairman, VUDA and Smt.V.Indira Dutt, Chair Person, World Telugu Federation signed the MoU in the presence of P.S.N.Raju Chairman, VUDA and representatives of the WTF. The VUDA Chairman P.S.N.Raju thanked the WTF for associating VUDA in the mission of promoting Telugu Culture &amp; Heritage.<br>While disclosing the details of the Project Venkatram Reddy, Vice Chairman, VUDA told the Press that the Telugu Culture &amp; Heritage aspects would be depicted episode by episode starting with the Satavahana era to the Modern Times. The greatness of Telugu Culture will be explained through a Light &amp; Sound show. Show will be conducted in English also for the convenience of Foreign and Non-Telugu visitors. Many supporting amenities would be developed to achieve the objectives. An Amphi theatre will also be promoted to conduct regular cultural shows to popularize the local and other Telugu Arts, the Vice Chairman added. As a whole the Museum brings the culture of Telugu as if it is happening wit us.<br>Smt.Indira Dutt, Chair Person, World Telugu Federation has said the Museum would be unique in several ways and would help both Telugu people and tourists to from other states to know various facets of Telugu Culture. The Museum would be rarest and unique in the State and would be developed as a proud to the Telugu people, she said.<br>Dr.Y.Lakshmi Prasad, Regional Chairman, WTF thanked the WTF and the VUDA for taking keen interest in establishing the Museum at Visakhapatnam. He said the Museum would definitely become an adding jewel to Visakhapatnam.<br />
              </p>
          </div>
          <div class="clr">
          </div>
